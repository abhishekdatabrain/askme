                  ...
                  <tr key={item.id} className="hover:bg-[#1A1A24]/60 transition-colors group">
                    ...
                    <td className="py-4 px-4 text-center">
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all cursor-pointer ${item.status === 'active'
