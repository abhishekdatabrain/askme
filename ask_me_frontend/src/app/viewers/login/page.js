        ...
        <div className="bg-[#12121C] border border-[#1F1F30] rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 rounded-xl bg-[#EB1000] hover:bg-[#CC0E00] text-white font-black text-xs shadow-lg transition flex items-center justify-center gap-2 cursor-pointer"
            >
              {isLoading ? (
                <>
